<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='yezhu'"  label='业主姓名' prop="yezhuName">
               <el-input v-model="ruleForm.yezhuName"  placeholder='业主姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yezhu'"  label='业主手机号' prop="yezhuPhone">
               <el-input v-model="ruleForm.yezhuPhone"  placeholder='业主手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yezhu'"  label='业主身份证号' prop="yezhuIdNumber">
               <el-input v-model="ruleForm.yezhuIdNumber"  placeholder='业主身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='yezhu'" label='业主头像' prop="yezhuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
                         :multiple="true"
                         :fileUrls="ruleForm.yezhuPhoto?ruleForm.yezhuPhoto:''"
                         @change="yezhuPhotoUploadChange"
                 ></file-upload>
             </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='yezhu'"  label='电子邮箱' prop="yezhuEmail">
               <el-input v-model="ruleForm.yezhuEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='zhiyuanzhe'" label='志愿者照片' prop="zhiyuanzhePhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
...
// 注册表 志愿者 的级联表
  ...
  methods: {
    ...
    yezhuPhotoUploadChange(fileUrls) {
        this.ruleForm.yezhuPhoto = fileUrls;
    },
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.yezhuName)&& 'yezhu'==this.flag){
                             this.$message.error('业主姓名不能为空');
                             return
                         }

                             if( 'yezhu' ==this.flag && this.ruleForm.yezhuPhone&&(!isMobile(this.ruleForm.yezhuPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.yezhuIdNumber)&& 'yezhu'==this.flag){
                             this.$message.error('业主身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.yezhuPhoto)&& 'yezhu'==this.flag){
                             this.$message.error('业主头像不能为空');
                             return
                         }

                             if( 'yezhu' ==this.flag && this.ruleForm.yezhuEmail&&(!isEmail(this.ruleForm.yezhuEmail))){
