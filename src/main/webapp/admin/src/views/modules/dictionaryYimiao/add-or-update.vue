<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="是否打疫苗编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="是否打疫苗编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否打疫苗编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="是否打疫苗编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="是否打疫苗" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="是否打疫苗" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否打疫苗" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
