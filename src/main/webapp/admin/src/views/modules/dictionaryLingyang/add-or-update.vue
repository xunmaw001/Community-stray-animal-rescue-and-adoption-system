<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="是否领养编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="是否领养编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否领养编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="是否领养编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="是否领养" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="是否领养" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否领养" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('是否领养不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="lingyang_types";
                        ruleForm["dicName"]="是否领养";
                        this.$http({
