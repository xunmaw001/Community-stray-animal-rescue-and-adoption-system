    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="业主姓名" prop="yezhuName">
                       <el-input v-model="ruleForm.yezhuName"
                                 placeholder="业主姓名" clearable  :readonly="ro.yezhuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="业主手机号" prop="yezhuPhone">
                       <el-input v-model="ruleForm.yezhuPhone"
                                 placeholder="业主手机号" clearable  :readonly="ro.yezhuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="业主身份证号" prop="yezhuIdNumber">
                       <el-input v-model="ruleForm.yezhuIdNumber"
                                 placeholder="业主身份证号" clearable  :readonly="ro.yezhuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="业主身份证号" prop="yezhuIdNumber">
                           <el-input v-model="ruleForm.yezhuIdNumber"
                                     placeholder="业主身份证号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="yezhuEmail">
                       <el-input v-model="ruleForm.yezhuEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.yezhuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="电子邮箱" prop="yezhuEmail">
                           <el-input v-model="ruleForm.yezhuEmail"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yezhuIdNumber: [
                              { required: true, message: '业主身份证号不能为空', trigger: 'blur' },
                   ...
                   yezhuPhoto: [
                              { required: true, message: '业主头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
