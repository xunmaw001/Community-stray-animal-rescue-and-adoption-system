        ...
        <el-dialog title="审核" :visible.sync="liulangdongwuOrderYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.liulangdongwuOrderYesnoTypes" placeholder="请选择审核类型">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="liulangdongwuOrderYesnoTypesShenhe">提 交</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
...
<script>
    ...
    //当前表下拉框搜索条件
        ...
        //评价
			...
			//评分
		    liulangdongwuCommentbackPingfenNumber:0,            };
        },
        created() {
        ...
        methods: {
            ...
            openYesnoTypes(id) {
                ...
                _this.form.liulangdongwuOrderYesnoTypes = "请选择审核结果";
                _this.liulangdongwuOrderYesnoTypesVisible = true;
            },

            liulangdongwuOrderYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.liulangdongwuOrderYesnoTypes == "请选择审核结果"){
