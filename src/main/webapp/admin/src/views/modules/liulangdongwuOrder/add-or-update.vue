    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.liulangdongwuPhoto" label="动物照片" prop="liulangdongwuPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (liulangdongwuForm.liulangdongwuPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请编号" prop="liulangdongwuOrderUuidNumber">
                       <el-input v-model="ruleForm.liulangdongwuOrderUuidNumber"
                                 placeholder="申请编号" clearable  :readonly="ro.liulangdongwuOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
            ...
            <input id="yezhuId" name="yezhuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="个人条件" prop="tiaojianContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.tiaojianContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tiaojianContent" label="个人条件" prop="tiaojianContent">
                            <span v-html="ruleForm.tiaojianContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   tiaojianContent: [
                              { required: true, message: '个人条件不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
