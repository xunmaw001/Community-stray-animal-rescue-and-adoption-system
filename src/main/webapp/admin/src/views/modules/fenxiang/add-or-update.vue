    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分享编号" prop="fenxiangUuidNumber">
                       <el-input v-model="ruleForm.fenxiangUuidNumber"
                                 placeholder="分享编号" clearable  :readonly="ro.fenxiangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="分享编号" prop="fenxiangUuidNumber">
                           <el-input v-model="ruleForm.fenxiangUuidNumber"
            ...
            <input id="yezhuId" name="yezhuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分享标题" prop="fenxiangName">
                       <el-input v-model="ruleForm.fenxiangName"
                                 placeholder="分享标题" clearable  :readonly="ro.fenxiangName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="分享标题" prop="fenxiangName">
                           <el-input v-model="ruleForm.fenxiangName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="分享类型" prop="fenxiangTypes">
                        <el-select v-model="ruleForm.fenxiangTypes" :disabled="ro.fenxiangTypes" placeholder="请选择分享类型">
                            <el-option
                                v-for="(item,index) in fenxiangTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="分享类型" prop="fenxiangValue">
                        <el-input v-model="ruleForm.fenxiangValue"
                            placeholder="分享类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="分享内容" prop="fenxiangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.fenxiangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fenxiangContent" label="分享内容" prop="fenxiangContent">
                            <span v-html="ruleForm.fenxiangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yezhuForm: {},
                ro:{
                    fenxiangUuidNumber: false,
                    liulangdongwuOrderId: false,
                    yezhuId: false,
                    fenxiangName: false,
                    fenxiangTypes: false,
                    fenxiangContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    fenxiangUuidNumber: new Date().getTime(),
                ...
                fenxiangTypesOptions : [],
                liulangdongwuOrderOptions : [],
                yezhuOptions : [],
                rules: {
                   fenxiangUuidNumber: [
                              { required: true, message: '分享编号不能为空', trigger: 'blur' },
                          ],
                   liulangdongwuOrderId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fenxiang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fenxiangTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fenxiang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fenxiangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
